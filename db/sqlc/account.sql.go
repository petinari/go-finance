...
update accounts set title =$1, description = $2, value = $3 where id = $1 returning id, user_id, category_id, title, type, description, value, date, created_at
`
...
func (q *Queries) UpdateAccount(ctx context.Context, arg UpdateAccountParams) (Account, error) {
	row := q.db.QueryRowContext(ctx, updateAccount, arg.Title, arg.Description, arg.Value)
	var i Account
	err := row.Scan(
		&i.ID,
		&i.UserID,
