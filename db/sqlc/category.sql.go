...
update categories set title = $1, description = $2 where id = $3 returning id, user_id, title, type, description, created_at
`
...
func (q *Queries) UpdateCategory(ctx context.Context, arg UpdateCategoryParams) (Category, error) {
	row := q.db.QueryRowContext(ctx, updateCategory, arg.Title, arg.Description, arg.ID)
	var i Category
	err := row.Scan(
		&i.ID,
		&i.UserID,
